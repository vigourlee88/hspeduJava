...
public class HouseView {
	...
	private HouseService houseService = new HouseService(2);// 设置数组大小为2
	...
	public void update() {
		...
		String name = Utility.readString(8, "");// 这里用户直接回车，表示不修改该信息，默认""
		if (!"".equals(name)) {// 修改
			house.setName(name);
		}
		...
		String address = Utility.readString(18, "");// 必须设置默认值
	...
	public void listHouses() {
		...
		for (int i = 0; i < houses.length; i++) {
			...
			System.out.println(houses[i]);// 默认调用toString()
		}
